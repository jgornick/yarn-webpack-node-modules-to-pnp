...
* Try to build w/ webpack (`yarn workspace node-modules build`)

Current output:

```
$ yarn workspace node-modules build
...
As proposed by @arcanis:

```
$ NODE_OPTIONS="-r $PWD/.pnp.cjs" yarn workspace node-modules build
asset bundle.js 2.88 KiB [emitted] (name: main)
./index.js 109 bytes [built] [code generated]
../../components/pnp/index.js 94 bytes [built] [code generated]
...
resolve 'lodash/times' in '/Users/joe/Projects/yarn-webpack-node-modules-to-pnp/workspaces/tools/node-modules'
  Cache miss
    ...
    using description file: /Users/joe/Projects/yarn-webpack-node-modules-to-pnp/workspaces/tools/node-modules/package.json (relative path: .)
      Field 'browser' doesn't contain a valid alias configuration
      resolve as module
        resolved by pnp to /Users/joe/Projects/yarn-webpack-node-modules-to-pnp/workspaces/tools/node-modules/node_modules/lodash/lodash.js
          using description file: /Users/joe/Projects/yarn-webpack-node-modules-to-pnp/workspaces/tools/node-modules/node_modules/lodash/package.json (relative path: ./lodash.js)
            using description file: /Users/joe/Projects/yarn-webpack-node-modules-to-pnp/workspaces/tools/node-modules/node_modules/lodash/package.json (relative path: ./lodash.js/times)
              no extension
                Field 'browser' doesn't contain a valid alias configuration
                /Users/joe/Projects/yarn-webpack-node-modules-to-pnp/workspaces/tools/node-modules/node_modules/lodash/lodash.js/times doesn't exist
              .js
                Field 'browser' doesn't contain a valid alias configuration
                /Users/joe/Projects/yarn-webpack-node-modules-to-pnp/workspaces/tools/node-modules/node_modules/lodash/lodash.js/times.js doesn't exist
              .json
                Field 'browser' doesn't contain a valid alias configuration
                /Users/joe/Projects/yarn-webpack-node-modules-to-pnp/workspaces/tools/node-modules/node_modules/lodash/lodash.js/times.json doesn't exist
              .wasm
                Field 'browser' doesn't contain a valid alias configuration
                /Users/joe/Projects/yarn-webpack-node-modules-to-pnp/workspaces/tools/node-modules/node_modules/lodash/lodash.js/times.wasm doesn't exist
              as directory
                /Users/joe/Projects/yarn-webpack-node-modules-to-pnp/workspaces/tools/node-modules/node_modules/lodash/lodash.js/times doesn't exist
  Parsed request is a module
  using description file: /Users/joe/Projects/yarn-webpack-node-modules-to-pnp/workspaces/tools/node-modules/package.json (relative path: .)
